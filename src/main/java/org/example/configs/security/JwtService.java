...
public class JwtService {
    ...
    public String generateAccessToken(KitchenUser user) {
        return generateToken(user, ACCESS_TOKEN_EXPIRATION);
    }

    public String generateRefreshToken(KitchenUser user) {
        return generateToken(user, REFRESH_TOKEN_EXPIRATION);
    }

    private String generateToken(KitchenUser user, long tokenExpiration) {
